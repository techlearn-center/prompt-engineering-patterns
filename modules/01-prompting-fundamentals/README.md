# Module 01: Prompting Fundamentals
...
- Understand the core concepts of Prompting Fundamentals
...
### What is Prompting Fundamentals?

Prompting Fundamentals is a fundamental component of Prompt Engineering Patterns: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Prompting Fundamentals like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/01-prompting-fundamentals/
```
...
```bash
ls modules/01-prompting-fundamentals/lab/starter/
```
...
cd modules/01-prompting-fundamentals/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/01-prompting-fundamentals/validation/validate.sh
```
...
1. What is the main purpose of Prompting Fundamentals?
...
- [ ] Validation script passes: `bash modules/01-prompting-fundamentals/validation/validate.sh`
...
**Next: [Module 02 →](../02-zero-shot-few-shot/)**
